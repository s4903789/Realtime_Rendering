...
void ShaderScene::initGL() noexcept {
    ...
    shader->loadShader("GouraudProgram","shaders/myshader_vert.glsl","shaders/myshader_frag.glsl");

    // This is how you might load up your own shaders
...
void ShaderScene::paintGL() noexcept {
    ...
    // uncomment the bits below when you have implemented alternative shader types
    ...
    // Note that all of the shaders should make use of the same Uniform names for the
    // MVP matrices. Be wary that variables in GLSL and C++ are case sensitive.
